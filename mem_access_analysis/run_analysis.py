...
feature_cols = ["Delta_with_1_last_read","Delta_with_1_last_write","Delta_with_2_last_read","Delta_with_2_last_write","Delta_with_3_last_read","Delta_with_3_last_write"]
...
for name, df in dfs.items():
    ...
    win = 100
    step = 50
    feats = extract_features_from_df(df,["Delta_with_1_last_read"],["Delta_with_1_last_write"],window = win,step = step,do_log=True)
